...
if __name__ == '__main__':
    ...
    k = 3
    # train_conv_path = 'data/inspired/train_data_processed_retrieval.jsonl'
    # valid_conv_path = 'data/inspired/valid_data_processed_retrieval.jsonl'
    # test_conv_path = 'data/inspired/test_data_processed_retrieval.jsonl'
    ...
    train_conv_data = read_file(train_conv_path)
    valid_conv_data = read_file(valid_conv_path)
    test_conv_data = read_file(test_conv_path)

    # new_train_conv_data, new_valid_conv_data, new_test_conv_data = random_retrieval(train_conv_data, valid_conv_data, test_conv_data, n = k)
    ...
    # new_train_conv_path = 'data/inspired/train_data_processed_retrieval_bm25.jsonl'
    # new_valid_conv_path = 'data/inspired/valid_data_processed_retrieval_bm25.jsonl'
    # new_test_conv_path = 'data/inspired/test_data_processed_retrieval_bm25.jsonl'

    new_train_conv_path = 'data/redial/train_data_processed_retrieval_bm25.jsonl'
    new_valid_conv_path = 'data/redial/valid_data_processed_retrieval_bm25.jsonl'
    new_test_conv_path = 'data/redial/test_data_processed_retrieval_bm25.jsonl'
    ...
    new_train_conv_data, new_valid_conv_data, new_test_conv_data = bm25_retrieval(train_conv_data, valid_conv_data, test_conv_data)
