...
from transformers import AutoModel, AutoTokenizer, RobertaForMaskedLM, BartForConditionalGeneration, BartTokenizer
from transformers import GPT2LMHeadModel
from transformers import AutoModelForCausalLM, AutoTokenizer

from utils import init_wandb_run, GENERATION, PROJECT_NAME, MODEL_NAME, wandb_logging, freeze_model_params, count_parameters
...
if __name__ == '__main__':
    ...
    print(tokenizer.tokenize('<movie>'))
    # assert 1==0
