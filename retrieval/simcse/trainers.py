...
class CLTrainer(Trainer):
    ...
    def train(self, train_dataset, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        """
    ...
    def save_tokenizer(self, output_dir: Optional[str] = None, state_dict=None):
